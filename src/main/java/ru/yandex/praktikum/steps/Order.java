...
public class Order {
    ...
    public Order(String[] color) {
        this.firstName = randomAlphabetic(8);
        this.lastName = randomAlphabetic(10);
        this.address = randomAlphabetic(20);
        this.metroStation = randomAlphabetic(5);
        this.phone = randomAlphabetic(10);
        this.rentTime = 1 + (int) (Math.random() * 365);
        DateFormat format = new SimpleDateFormat("yyyy-MM-dd");
        this.deliveryDate = format.format(new Date());
        this.comment = randomAlphabetic(20);
        this.color = color;
    }
